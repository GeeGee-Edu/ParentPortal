...
attendapp.controller('MemberController', function($scope, CohortMemberFactory) {
  'use strict';
  ...
  $scope.cohortFilter = function(member) {
    ...
    for (var i = 0; i < $scope.cohortMembers.uniqueCohorts.length; i++) {
      ...
      if ($scope.cohortMembers.uniqueCohorts[i].selected && member.cohort.toLowerCase().indexOf(
